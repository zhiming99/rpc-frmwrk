            ...
            try:
                if port[ 'PortClass'] == sslPort :
                    ...
                    if self.bServer :
                        ...
                        certPath = sslFiles[ "CertFile" ]
                        dirPath = os.path.dirname( certPath )
                        if IsRpcfSelfGenKey( self, bGmSSL, certPath ) :
                            '''generated by rpcfg'''
...
''' )
    ...
    def AddMiscOptions( self, grid:Gtk.Grid, startCol, startRow, confVals : dict ) :
        ...
        maxconnEdit.set_sensitive(self.bServer)
        ...
        tsCheck.set_sensitive( self.bServer )
        tsCheck.connect(
        ...
        updWsBtn.set_sensitive( self.bServer) 
    ...
    def AddInstallerOptions( self, grid:Gtk.Grid, startCol, startRow, confVals : dict ) :
        ...
        checkCfgWs.set_sensitive( self.bServer )
        ...
        checkCfgKrb5.set_sensitive( self.bServer )
        ...
        checkKProxy.set_sensitive( self.bServer )
    ...
    def Export_Installer( self, destPath : str, bServer: bool ) -> int :
        ...
        try:
            ...
            ret = BuildInstallersInternal( cfgVal,
                initFile, debPath, self.hasSSL, self.bServer )
