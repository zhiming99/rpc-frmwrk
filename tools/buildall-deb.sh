...
bash net-tools procps swig openjdk-8-jdk-headless cmake libcommons-cli-java ccache

sudo apt-get -y install sip5-tools || apt-get -y install sip-dev python3-sip python3-sip-dev || true
