...
fuse3-devel fuse3 fuse3-libs npm vim screen git \
...
npm -g install assert browserify buffer exports long lz4 process put safe-buffer stream xxhashjs xxhash webpack webpack-cli minify
