...
typedef enum 
{
    ...
    DECL_CLSID( CStTaskConfigListNode ),
    DECL_CLSID( CStUsingDirective ),
    DECL_CLSID( CStAccessDeclNode ),
    DECL_CLSID( CStAccessDeclListNode ),
    DECL_CLSID( CStAccessDeclsNode ),
    DECL_CLSID( CStGlobalVarDeclListNode ),
    DECL_CLSID( CStConfigDeclNode ),
    DECL_CLSID( CStDeclsNode ),
    DECL_CLSID( CStSingleResourceDeclNode ),
    DECL_CLSID( CStResourceDeclNode ),
    DECL_CLSID( CStResourceDeclListNode ),
    DECL_CLSID( CStResourceSectionNode ),
    ...
    DECL_CLSID( CStProgConfigNode ),
    DECL_CLSID( CStSymbolicVarNode ),
    DECL_CLSID( CStFbTaskNode ),
    DECL_CLSID( CStProgCnxnNode ),
    DECL_CLSID( CStProgConfElemNode ),
