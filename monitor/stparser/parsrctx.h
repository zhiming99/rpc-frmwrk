...
#define CONFLICT_STATE      533: case 560
// the state to replace TOK_MINUS with TOK_SUB
#define SUBEXPR_STATE     68
#define LVALUE_BIT_STATES      62: case 110: case 300: case 408
#define METHOD_RET_STATE     541
#define USING_SEP_STATE     90
#define CASESEL_CHECK_STATES     std::vector<int>({ 73, 74 })
