    ...
    CBPlusNode* pParent, guint32 dwSlotIdx )
{
    ...
    do{
        ...
        // key to adde to the parent slot.
        KEYPTR_SLOT oKey;
        ...
        if( !IsLeaf() )
        {
            ...
            // copy the node idx before the key move up 
