...
If you are a Ubuntu user or a Fedora user, you may want to install the [`deb package` or `rpm package`](https://github.com/zhiming99/rpc-frmwrk/releases/tag/0.4.0) to skip the painstaking building process.
