...
1. `kinit` now works with rpc-frmwrk with the rpc channel, that is, if the kerberos kdc is behind the firewall, and not open to the internet, the client still has a way to get authenticated.   
