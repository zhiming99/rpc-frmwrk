...
1. There are several places in the router to redesign for new requirements/discoveries. There are a lot of work to do. The detail has appended to the todo.txt.
