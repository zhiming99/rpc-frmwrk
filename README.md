...
1. Upgraded the synchronous proxy code generation with the new macro, before the start of session manager design. It is now a easy task to write a proxy with a few lines. for detail information, please refer to test/helloworld.   
