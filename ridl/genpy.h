...
#define EMIT_DISCLAIMER_PY \
do{ \
Wa( "# GENERATED BY RIDLC, MAKE SURE TO BACKUP BEFORE RUNNING RIDLC AGAIN" );\
Wa( "# Copyright (C) 2023  zhiming <woodhead99@gmail.com>" ); \
Wa( "# This program can be distributed under the terms of the GNU GPLv3." ); \
}while( 0 )
