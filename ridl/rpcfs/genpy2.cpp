...
void EmitExceptHandler( bool bList, bool bNoRet = false,
    ...
    ObjPtr pRoot )
{
    ...
    do{
        ...
        ret = GenSvcFiles2( pWriter, pRoot );
        if( ERROR( ret ) )
            break;
...
bool CImplPyMainFunc2::HasAsync(
    CServiceDecl* pSvc )
{
    gint32 ret = 0;
