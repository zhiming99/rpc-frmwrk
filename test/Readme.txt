Introduction of the Examples:
    ...
    stmtest: To demonstrate the basic chatting function with the local/remote streaming support.
    
    sftest: To demonstrate a simple file-server with the local/remote streaming support.
