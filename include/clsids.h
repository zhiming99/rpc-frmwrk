...
typedef enum : guint32
{
    ...
    DECL_CLSID( CFuseTextFile ),
    DECL_CLSID( CFuseEvtFile ),
    DECL_CLSID( CFuseReqFileSvr ),
    DECL_CLSID( CFuseRespFileSvr ),
    DECL_CLSID( CFuseReqFileProxy ),
    ...
    DECL_CLSID( CFastRpcServerState ),
    DECL_CLSID( CRpcStreamChannelSvr ),
